...
@Component({
  selector: 'app-settings-operation',
  templateUrl: './settings-operation.component.html',
  styleUrls: ['./settings-operation.component.css']
})
export class SettingsOperationComponent implements OnInit {
	...
	settingsHoverAction: any[] = [{hover: false, selected: false, route: 'account'}, {hover: false, selected: false, route: 'account'}, {hover: false, selected: false, route: 'account'}, {hover: false, selected: false, route: 'account'}, {hover: false, selected: false, route: 'account'}, {hover: false, selected: false, route: 'referrals'}, {hover: false, selected: false, route: 'schedule'}, {hover: false, selected: false, route: 'users'}];
  ...
  selectMenu(indx){
	...
	this.router.navigate(['../operations', {mnid: indx}], {relativeTo: this.activatedRoute}).then(() => {
